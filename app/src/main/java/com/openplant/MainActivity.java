...
public class MainActivity extends Activity
    ...
    private class CouchClientTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            ...
            HttpTransportSE transport = new HttpTransportSE("http://10.0.2.2:8734/MongoService/Service/?wsdl");
